...
const user = {
  ...
  full_name: "testing",
  username: "test",
  profile_image_url: "http://testi.com/user/test.png",
  age: 21,
  phone_number: "+6283843211234",
  ...
  test("should return http status code 400 Bad Request when usename is an empty string", async () => {
    const { body } = await request(app)
      ...
      .send({
        full_name: "dika",
        username: "",
        profile_image_url: "http://testi.com/user/dika.png",
        age: 21,
        phone_number: "+6283843211234",
        email: "comfo@gmail.com",
      })
  ...
  test("should return http status code 400 Bad Request when URL is invalid", async () => {
    const { body } = await request(app)
      ...
      .send({
        full_name: "dika",
        username: "dik",
        profile_image_url: "httpzzz://testi.com/user/dika.png",
        age: 21,
        phone_number: "+6283843211234",
        email: "comfo@gmail.com",
      })
